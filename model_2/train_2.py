...
from data_loader_2 import train_loader, val_loader
from model_2 import ScrewClassifier

MODEL_SAVE_PATH = Path(__file__).resolve().parent / "screw_classifier_2.pth"
